...
<body>
%{--<a href="#create-kecamatan" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>--}%
...
%{--</ul>--}%
%{--</div>--}%
<div id="create-kecamatan" class="content scaffold-create" role="main">
    ...
    <g:form class="form-horizontal form-label-left" url="[resource: kecamatanInstance, action : 'save']" >
    <fieldset class="form">
